...
public class TaxiDriverDaoImpl {
    ...
    public int findDriverIdByEnteredLoginAndPassword(String name, String password) throws DaoException{

        int result = 0;

        try(Connection connection = ConnectionPool.getInstance().getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement(Constant.FIND_DRIVER_ID_BY_LOGIN)) {
            ...
            throw new DaoException("findDriverIdByEnteredLoginAndPasswordError ", e);
        }
