...
<c:set var="langPage" scope="session" value="/jsp/list_of_appropriate_taxi.jsp"/>

<div id="imageBack">
<nav class="navbar navbar-light" id= "back">
      <a class="navbar-brand" href="${request.getContextPath}/project/jsp/order_with_taxi_choose.jsp">
