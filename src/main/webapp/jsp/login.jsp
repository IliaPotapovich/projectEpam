...
<c:set var="langPage" scope="session" value="/jsp/login.jsp"/>
...
<div class="container">
  <div class="row">
    ...
    <div class="col">
        ...
        <div class="col">
               <button type="button" id="register" class="btn btn-primary btn-lg btn-block" onclick="location.href='${request.getContextPath}/project/jsp/registerpage.jsp';"><fmt:message key="login.registerSubmit" bundle="${ rb }"/></button>
                                        ${regSuccess}
            </div>
</div>
</div>
