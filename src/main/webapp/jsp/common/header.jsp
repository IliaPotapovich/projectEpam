...
<head>
    ...
    <title><fmt:message key="taxiProject" bundle="${rb}"/></title>
    <meta charset="utf-8"/>
    ...
    #navbar {
      ...
      #navbar #logo .dropdown-item {
            ...
            color: #000000;
             ...
             #navbar #logo .dropdown-item:hover {
                     background-position: 0 0px;
                      cursor: pointer;
...
<div class="container">
    ...
    <form name="enterInUserRoom" id="logo" action="${request.getContextPath}/project/controller" method="post" >
            <input type="hidden" name="command" value="forward"/>
            <input type="hidden" name="page" value="/jsp/common/start_page.jsp"/>
            <button class="dropdown-item" ><fmt:message key="taxi" bundle="${ rb }"/></button>
    </form>
    <form name="enterInUserRoom" id="showTaxiForm" action="${request.getContextPath}/project/controller" method="post" >
            <input type="hidden" name="command" value="forward"/>
            <input type="hidden" name="page" value="/jsp/common/start_page.jsp"/>
            <button class="dropdown-item" ><fmt:message key="main" bundle="${ rb }"/></button>
    </form>
...
<form name="enterInUserRoom" id="showTaxiForm" action="${request.getContextPath}/project/controller" method="post" >
        <input type="hidden" name="command" value="forward"/>
        <input type="hidden" name="page" value="/jsp/common/about_company.jsp"/><button class="dropdown-item" ><fmt:message key="aboutCompany" bundle="${ rb }"/></button>
</form>
