...
<c:set var="langPage" scope="session" value="/jsp/user/quick_order.jsp"/>
...
<div class="container">
 ...
 <h2><fmt:message key="weWorkForYou" bundle="${ rb }"/></h2>
    ...
    <div class="input-group mb-3">
      ...
      <input type="text" class="form-control" name="placeToCoordX" pattern="([0-9]{1,3})" value="" placeholder="<fmt:message key="toX" bundle="${ rb }"/>"  aria-label="Default" aria-describedby="inputGroup-sizing-default">
    </div>
    ...
    <div class="input-group mb-3">
      ...
      <input type="text" name="placeToCoordY" pattern="([0-9]{1,3})" value="" placeholder="<fmt:message key="toY" bundle="${ rb }"/>" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
    </div>
