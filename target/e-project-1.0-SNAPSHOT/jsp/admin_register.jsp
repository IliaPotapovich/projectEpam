...
<c:set var="langPage" scope="session" value="/jsp/admin_register.jsp"/>
...
<div class="container">
  <div class="row">
    ...
    <div class="col">
    <h2><fmt:message key="adminReg" bundle="${ rb }"/></h2>
    <form name="regDriverForm" action="${request.getContextPath}/project/controller" method="post" >
        ...
        <div class="input-group mb-3">
         ...
         <input type="text" name="regAdminName" class="form-control" aria-label="Large" aria-describedby="inputGroup-sizing-sm" pattern="[A-Za-zА-Яа-я]{3,15}" placeholder=<fmt:message key="from3to20" bundle="${ rb }"/> required/><br/>
        </div>
        <br/>
        ...
        <div class="input-group mb-3">
         ...
         <input type="text" name="regAdminPassword" class="form-control" aria-label="Large" aria-describedby="inputGroup-sizing-sm" pattern="([A-Za-zА-Яа-я0-9]{3,15})" placeholder=<fmt:message key="from3to15" bundle="${ rb }"/> required/>
         </div>
         <br/>
