...
<c:set var="langPage" scope="session" value="/jsp/order_with_taxi_choose.jsp"/>
...
<br/><br/>
    ...
    <div class="input-group mb-3">
      ...
      <input type="text" class="form-control" name="placeToCoordX" value="" placeholder="<fmt:message key="toXreq" bundle="${ rb }"/>" required aria-label="Default" aria-describedby="inputGroup-sizing-default">
    </div>
    ...
    <div class="input-group mb-3">
      ...
      <input type="text" name="placeToCoordY" value="" placeholder="<fmt:message key="toYreq" bundle="${ rb }"/>" class="form-control" required aria-label="Default" aria-describedby="inputGroup-sizing-default">
    </div>
