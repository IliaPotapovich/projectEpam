...
<c:set var="langPage" scope="session" value="/jsp/taxi_start_page.jsp"/>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-6">
        ...
        <div class="col">
            <button type="button" id="register" class="btn btn-primary btn-block" onclick="location.href='${request.getContextPath}/project/jsp/change_driver_password.jsp';"><fmt:message key="changePassword" bundle="${ rb }"/></button>
                        ${passChanged}
            </div>
</div>
</div>
