...
<c:set var="langPage" scope="session" value="/jsp/taxi_find.jsp"/>
...
<form name="findDriverById" action="${request.getContextPath}/project/controller" method="post">
 <input type="hidden" name="command" value="find_driver_by_id"/>
    ...
    <div class="input-group-prepend">
      ...
      <input type="text" name="taxiDriverId" class="form-control" aria-label="Recipient's username" aria-describedby="button-addon2" required>
...
<form name="findDriverById" action="${request.getContextPath}/project/controller" method="post">
 <input type="hidden" name="command" value="find_driver_by_name"/>
    ...
    <div class="input-group-prepend">
      ...
      <input type="text" name="taxiDriverName" class="form-control" aria-label="Recipient's username" aria-describedby="button-addon2" required>
      <div class="input-group-append">
        <button class="btn btn-outline-warning" type="input" id="button-addon2"><fmt:message key="find.submit" bundle="${rb}"/></button>
    </form>
      </div>
...
<form name="findDriverById" action="${request.getContextPath}/project/controller" method="post">
 <input type="hidden" name="command" value="find_car_by_id"/>
    ...
    <div class="input-group-prepend">
      ...
      <input type="text" name="taxiCarId" class="form-control" aria-label="Recipient's username" aria-describedby="button-addon2" required>
      <div class="input-group-append">
        <button class="btn btn-outline-warning" type="input" id="button-addon2"><fmt:message key="find.submit" bundle="${rb}"/></button>
    </form>
      </div>
...
<form name="findDriverById" action="${request.getContextPath}/project/controller" method="post">
 <input type="hidden" name="command" value="find_car_by_owner_id"/>
    ...
    <div class="input-group-prepend">
      ...
      <input type="text" name="taxiOwnerId" class="form-control" aria-label="Recipient's username" aria-describedby="button-addon2" required>
      <div class="input-group-append">
        <button class="btn btn-outline-warning" type="input" id="button-addon2"><fmt:message key="find.submit" bundle="${rb}"/></button>
    </form>
      </div>
...
<form name="deleteDriverById" action="${request.getContextPath}/project/controller" method="post">
 <input type="hidden" name="command" value="delete_driver_by_id"/>
    ...
    <div class="input-group-prepend">
      ...
      <input type="text" name="driverDeleteId" class="form-control" aria-label="Recipient's username" aria-describedby="button-addon2" placeholder="<fmt:message key="enterPrivateNumberOfDriver" bundle="${ rb }"/>" required>
      <div class="input-group-append">
...
<form name="deleteCarById" action="${request.getContextPath}/project/controller" method="post">
 <input type="hidden" name="command" value="delete_car_by_id"/>
    ...
    <div class="input-group-prepend">
      ...
      <input type="text" name="carDeleteId" class="form-control" aria-label="Recipient's username" aria-describedby="button-addon2" placeholder="<fmt:message key="enterPrivateNumberOfCar" bundle="${ rb }"/>" required>
      <div class="input-group-append">
        <button class="btn btn-outline-warning" type="input" id="button-addon2"><fmt:message key="delete" bundle="${rb}"/></button>
    </form>
      </div>
